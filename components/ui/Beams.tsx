...
const hexToRGB = (hex: string) => {
	const c = hex.replace("#", "");
	return [parseInt(c.substring(0, 2), 16) / 255, parseInt(c.substring(2, 4), 16) / 255, parseInt(c.substring(4, 6), 16) / 255] as [number, number, number];
};
...
function createStackedPlanesGeometry(n: number, width: number, height: number, spacing: number, heightSegments: number) {
